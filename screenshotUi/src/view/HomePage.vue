            ...
            <div class="main" v-if="histories.length!=0">
                ...
                <div class="resultBody">
                    <div class="result">
                        ...
                        <el-button type="primary" icon="el-icon-document-copy" @click="copyResult(histories[selectIndex].ocrResult)">点我复制</el-button>
...
export default {
      ...
      histories: [
        {
          ...
          time: '19:27:26',
          ocrResult: 'heloo',
          ocrImgUrl: 'file:///C:\\ProgramDataSnipasteOcr\\20201011192725.png'
        },
        {
          id: 35,
          date: '2020-12-11',
  ...
  methods: {
    ...
    ocr () {
      ...
      window.getBackend.then((backend) => {
        backend.ocr('', (rsp) => {
          self.timeInterval = setInterval(this.ocr_result, 1000)
        })
      })
    },
    ocr_result () {
